...
if __name__ == '__main__':
    ...
    # Iterate through LOUO splits
    for train_loader, test_loader, renorm_transform in get_dataloader(data_set_name, N, dataset_dir, num_past_frames, num_future_frames):
