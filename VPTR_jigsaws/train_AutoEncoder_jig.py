...
if __name__ == '__main__':
    ckpt_save_dir = Path('C:\\\VPTR_jigsaws\\MovingMNIST\\VPTR_ckpts\\MNIST_ResNetAE_MSEGDLgan_ckpt')
    tensorboard_save_dir = Path('C:\\VPTR_jigsaws\MovingMNIST\\VPTR_ckpts\\MNIST_ResNetAE_MSEGDLgan_tensorboard')
