...
if __name__ == '__main__':
    ckpt_save_dir = Path("D:\VPTR_jigsaws\jigsaws_suturing\JIGSAWS_ResNetAE_MSEGDLgan_ckpt")
    tensorboard_save_dir = Path("D:\VPTR_jigsaws\jigsaws_suturing\JIGSAWS_ResNetAE_MSEGDLgan_tensorboard")
