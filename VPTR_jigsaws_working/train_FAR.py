...
if __name__ == '__main__':
    set_seed(2021)
    ckpt_save_dir = Path('C:\VPTR_jigsaws_working\jigsaws_suturing\JIGSAWS_FAR_MSEGDLgan_ckpt')
    tensorboard_save_dir = Path('C:\VPTR_jigsaws_working\jigsaws_suturing\JIGSAWS_FAR_MSEGDLgan_tensorboard')
    resume_AE_ckpt = Path('C:\VPTR_jigsaws_working\jigsaws_suturing\JIGSAWS_ResNetAE_MSEGDLgan_ckpt').joinpath('epoch_100.tar')
